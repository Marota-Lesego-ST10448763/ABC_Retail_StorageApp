...
namespace ABCRetailers.Services
{
    public class FunctionsApiClient : IFunctionsApi
    {
        ...
        // Base routes for the Azure Functions
        ...
        private const string UploadsListRoute = "uploads"; // GET endpoint for all uploads
        ...
        // Create a product with optional image
    ...
    // Minimal extension to support PATCH requests
